...
if ( ! class_exists( 'RVR_Booking_Widget' ) ) {
	...
	class RVR_Booking_Widget extends WP_Widget {
		...
		public function widget( $args, $instance ) {
			...
			$name_required_text         = ( ! empty( $instance['name_required_text'] ) ) ? $instance['name_required_text'] : esc_html__( 'Name field is required.', 'realhomes-vacation-rentals' );
			...
			$country_field_text         = ( ! empty( $instance['country_field_text'] ) ) ? $instance['country_field_text'] : esc_html__( 'Country of residence', 'realhomes-vacation-rentals' );
			$country_field_placeholder  = ( ! empty( $instance['country_field_placeholder'] ) ) ? $instance['country_field_placeholder'] : esc_html__( 'Enter Country of residence', 'realhomes-vacation-rentals' );
			$country_required_text      = ( ! empty( $instance['country_required_text'] ) ) ? $instance['country_required_text'] : esc_html__( 'Country field is required.', 'realhomes-vacation-rentals' );			
			$phone_field_text           = ( ! empty( $instance['phone_field_text'] ) ) ? $instance['phone_field_text'] : esc_html__( 'Phone', 'realhomes-vacation-rentals' );
			$phone_field_placeholder    = ( ! empty( $instance['phone_field_placeholder'] ) ) ? $instance['phone_field_placeholder'] : esc_html__( 'Enter Phone', 'realhomes-vacation-rentals' );
			$phone_required_text        = ( ! empty( $instance['phone_required_text_placeholder'] ) ) ? $instance['phone_required_text'] : esc_html__( 'Phone Number is required', 'realhomes-vacation-rentals' );
			...
			$name_required_text         = apply_filters( 'wpml_translate_single_string', $name_required_text, 'Widgets', 'RVR - Name Required Text' );
			...
			$country_field_text         = apply_filters( 'wpml_translate_single_string', $country_field_text, 'Widgets', 'RVR - Country Label' );
			$country_field_placeholder  = apply_filters( 'wpml_translate_single_string', $country_field_placeholder, 'Widgets', 'RVR - Country Placeholder' );
			$country_required_text      = apply_filters( 'wpml_translate_single_string', $country_required_text, 'Widgets', 'RVR - Country Required Text' );		
			$phone_field_text           = apply_filters( 'wpml_translate_single_string', $phone_field_text, 'Widgets', 'RVR - Phone Label' );
			$phone_field_placeholder    = apply_filters( 'wpml_translate_single_string', $phone_field_placeholder, 'Widgets', 'RVR - Phone Placeholder' );
			$phone_required_text        = apply_filters( 'wpml_translate_single_string', $phone_required_text, 'Widgets', 'RVR - Phone Required Text' );			
                    ...
                    <div class="rvr-booking-form-wrap">
                        ...
                        <form class="rvr-booking-form" method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
                            ...
                            <div class="option-bar large rvr_no_top_border">
                                ...
                                <input id="rvr-user-name-<?php echo esc_attr( $this->id ); ?>" type="text" name="user_name" class="rvr-name-required" placeholder="<?php echo esc_attr( $name_field_placeholder ); ?>" title="<?php echo esc_attr( $name_required_text ); ?>">
                            </div>
                            ...
                            <div class="option-bar large">
                                ...
                                <input id="rvr-phone-<?php echo esc_attr( $this->id ); ?>" type="text" name="phone" class="rvr-phone required" placeholder="<?php echo esc_attr( $phone_field_placeholder ); ?>" title="<?php echo esc_attr( $phone_required_text ); ?>">
                            </div>
		...
		public function form( $instance ) {
			$instance = wp_parse_args(
				...
				array(
					...
					'name_required_text'         => esc_html__( 'Name field is required.', 'realhomes-vacation-rentals' ),
			...
			$name_required_text         = esc_attr( $instance['name_required_text'] );
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'name_required_text' ) ); ?>"><?php esc_html_e( 'Required Name Text (If field is empty)', 'realhomes-vacation-rentals' ); ?></label>
                <input id="<?php echo esc_attr( $this->get_field_id( 'name_required_text' ) ); ?>"
                       name="<?php echo esc_attr( $this->get_field_name( 'name_required_text' ) ); ?>" type="text"
                       value="<?php echo esc_attr( $name_required_text ); ?>" class="widefat"/>
            </p>
		...
		public function update( $new_instance, $old_instance ) {
			...
			$instance['name_required_text']         = strip_tags( $new_instance['name_required_text'] );
			...
			do_action( 'wpml_register_single_string', 'Widgets', 'RVR - Name Required Text', $instance['name_required_text'] );
